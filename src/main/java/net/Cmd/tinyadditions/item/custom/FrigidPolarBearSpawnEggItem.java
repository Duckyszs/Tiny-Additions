...
public class FrigidPolarBearSpawnEggItem extends Item {

    public FrigidPolarBearSpawnEggItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        ModEntities.FRIGID_POLAR_BEAR.spawn(world, pos, SpawnReason.SPAWN_EGG);
